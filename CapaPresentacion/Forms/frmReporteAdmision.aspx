<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeBehind="frmReporteAdmision.aspx.cs" Inherits="CapaPresentacion.Forms.frmReporteAdmision" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <script type="text/javascript" src="../Scripts/TexboxEnterNextControl.js"></script>
    ...
    <asp:GridView ID="grdReporteAdmision" runat="server" CssClass="gridViewCita" AutoGenerateColumns="false" >
        <Columns>
            ...
            <asp:BoundField DataField="col4" HeaderText="Fecha Admision" />
            <asp:BoundField DataField="col5" HeaderText="Hora Admision" /> 
             <asp:BoundField DataField="col6" HeaderText="Servicio" />
             <asp:BoundField DataField="col7" HeaderText="Precio" />
             <asp:BoundField DataField="col8" HeaderText="Estado" /> 
        </Columns>
        <EmptyDataTemplate>
