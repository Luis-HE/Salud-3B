...
namespace CapaPresentacion.DicomClass
{
    public class DicomDecoder
    {
        ...
        public double windowCentre = 0, windowWidth = 0;
        ...
        public bool oddLocations;  // one or more tags at odd locations
        public bool bigEndianTransferSyntax = false;
        public bool inSequence;
        public bool widthTagFound = false;
        public bool heightTagFound = false;
        public bool pixelDataTagFound = false;
        public int location = 0;
        public int elementLength;
        public int vr;  // Value Representation
        public int min8 = byte.MinValue;
        public int max8 = byte.MaxValue;
        public int min16 = short.MinValue;
        public int max16 = ushort.MaxValue;
        public int pixelRepresentation;
        public double rescaleIntercept = 0.0;// Default value
        public double rescaleSlope = 1.0; // Default value    
        public byte[] reds;
        public byte[] greens;
        public byte[] blues;
        public byte[] vrLetters = new byte[2];
        public List<byte> pixels8;
        public List<byte> pixels24; // 8 bits bit depth, 3 samples per pixel
        public List<ushort> pixels16;
        public List<int> pixels16Int;
        public void OpenReadFileDicom(string dicomFileName)
        {
            file = new BinaryReader(File.OpenRead(dicomFileName));// para uso WEB, en windows es diferente
        ...
        public string GetString(int length)
        {
            ...
            location += length;
            string s = ASCIIEncoding.ASCII.GetString(buf);
            return s;
        }
        public byte GetByte()
        {
        ...
        public string GetHeaderInfo(int tag, string value)
        {
        ...
        public void AddInfo(int tag, string value)
        {
        ...
        public void AddInfo(int tag, int value)
        {
            AddInfo(tag, Convert.ToString(value));
        }
        public void GetSpatialScale(string scale)
        {
        ...
        public bool ReadFileInfo()
        {
            ...
            {
                dicmFound = true;// We have a DICOM 3.0 file
            }
