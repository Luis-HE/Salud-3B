...
{
   public  class Entidad_HC_CE_ATENCION_ADULTO_MAYOR
    {
        public int id_atencion_adulto_mayor { get; set; }
        ...
        public string medicamentos_frecuentes { get; set; }
        public string reaccion_adversa_medicamentos { get; set; }
        public string valoracion_clinica { get; set; }
        public string categorias_adulto_mayor { get; set; }
